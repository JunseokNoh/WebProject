...
<ul class="navbar-nav mr-auto"> 
	...
	<a class="dropdown-item " href="./intro.jsp" >실시간 랭킹</a> 
	<a class="dropdown-item " href="./outro.jsp" >음악 차트</a> 
	<a class="dropdown-item " href="./Sound.jsp" >영화 차트</a> 
	<a class="dropdown-item " href="./Emoji.jsp" >도서 차트</a> 
